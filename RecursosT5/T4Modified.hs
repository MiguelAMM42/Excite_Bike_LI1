...
module RecursosT5.T4Modified where
...
move t m (Jogador p x v c ar@(Ar y i g)) | x == xBloco || not (intersetam segRetaTrajetoria segRetaBloco) = Jogador p x' v c ar{alturaJogador=y'}
